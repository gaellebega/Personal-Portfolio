      ...
      <section className="flex ">
        <div className="w-1/2  bg-[#0b1120] h-screen">
          ...
          <div>
            ...
            <p className="text-[#4d4dff]">const <span className="text-[#19ccbd] ">githubLink</span> <a href="https://github.com/gaellebega" className="text-red-300">https://github.com/gaellebega</a></p>
          </div>
        </div>
